...
public class CPNCalculator{
    ...
    public double evaluate(GTNode<ExpElem> expr){
        ...
        else if (elem.operator.equals("PI")) { 
            return Math.PI;
        }
        else if (elem.operator.equals("E")) { 
            return Math.E;
        }
        else if (elem.operator.equals("+")) { 
            double val = 0;
        ...
        else if (elem.operator.equals("sqrt")) { 
            double val = evaluate(expr.getChild(0));
            return Math.sqrt(val);
        }
        else if (elem.operator.equals("log")) {  
        ...
        else if (elem.operator.equals("sin")){
        ...
        else if (elem.operator.equals("cos")){
            if (expr.numberOfChildren() == 1) {
                double val = evaluate(expr.getChild(0));
                return Math.cos(val);
            } else {
        ...
        else if (elem.operator.equals("tan")){
            if (expr.numberOfChildren() == 1) {
                double val = evaluate(expr.getChild(0));
                return Math.tan(val);
            } else {
