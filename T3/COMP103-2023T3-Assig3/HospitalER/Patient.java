 ...
 * each treatment will have a department name and the amount of time the
 * treatment will take
 * The treatment at the head of the queue is the "current treatment" which the
 * patient is about to start
 ...
 * getCurrentDepartment() -> String (name of department for the treatment needed
 * now)
 */
...
public class Patient implements Comparable<Patient> {
    ...
    // Methods for simulating the progress of the Patient through their waiting and
    // their treatments
    ...
    public String toString() {
        ...
        ans.append(", pri:").append(priority).append(", Ar:").append(arrival).append(", ").append("treat: ")
                .append(totalTreatmentTime).append(" wait: ").append(totalWaitTime).append("\n    ");
